...
function M.get(c, opts)
	...
	return {
		...
		MatchParen                  = { bg = c.selectionBackground, bold = true }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
		-- ModeMsg                     = { fg = c.fg_dark, bold = true },                                                        -- 'showmode' message (e.g., "-- INSERT -- ")
		-- MsgArea                     = { fg = c.fg_dark },                                                                     -- Area for messages and cmdline
		-- MoreMsg                     = { fg = c.blue },                                                                        -- |more-prompt|
		-- NonText                     = { fg = c.dark3 },                                                                       -- '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
		Number                      = { fg = c.darkOrange },          --  a number constant: 234, 0xff
		Normal                      = { fg = c.white, bg = c.background1 }, -- normal text
		...
		NormalFloat                 = { fg = c.white, bg = c.background1 }, -- Normal text in floating windows.
		FloatBorder                 = { fg = c.floatBorder, bg = c.background1 },
		FloatTitle                  = { fg = c.floatBorder, bg = c.backgroundFloat },
		Pmenu                       = { bg = c.backgroundFloat, fg = c.white }, -- Popup menu: normal item.
		...
		VisualNOS                   = { bg = c.selectionBackground }, -- Visual mode selection when vim is "Not Owning the Selection".
		...
		LspReferenceText            = { bg = c.backgroundLight }, -- used for highlighting "text" references
		LspReferenceRead            = { bg = c.backgroundLight }, -- used for highlighting "read" references
		LspReferenceWrite           = { bg = c.backgroundLight }, -- used for highlighting "write" references
